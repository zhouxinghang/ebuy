...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
   ...
   <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/purchase.base.2012.css" />
   <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/purchase.sop.css" />
   <title>订单成功页面 - 易买商城</title>
   ...
   <script type="text/javascript" src="${pageContext.request.contextPath}/js/ebuy.js" charset="utf-8"></script>
</head> <body id="mainframe">
<!--shortcut start-->
<jsp:include page="commons/shortcut.jsp" />
<!--shortcut end-->
<div class="w" id="headers">
		<div id="logo"><a href="${pageContext.request.contextPath}/"><img alt="易买商城" src="${pageContext.request.contextPath}/images/ebuy-logo.gif"></a></div>

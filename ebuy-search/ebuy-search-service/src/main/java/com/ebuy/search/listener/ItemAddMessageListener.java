package com.ebuy.search.listener;

import com.ebuy.common.pojo.SearchItem;
import com.ebuy.search.mapper.SearchItemMapper;
...
public class ItemAddMessageListener implements MessageListener {
    ...
    public void onMessage(Message message) {
        try {
            ...
            logger.info("ItemMessageListener.onMessage.itemAddTopic.searchItem: {}", searchItem.toString());
            //创建文档对象
